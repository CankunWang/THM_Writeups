...
## Key Techniques
- SMB and AD enumeration with hash-based initial access
- Writable script abuse for scheduled higher-privileged execution
- LLMNR/Responder hash capture and cracking
